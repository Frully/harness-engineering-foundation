      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Mobile session restored.', style: Theme.of(context).textTheme.displayMedium),
            ...
            const SizedBox(height: 12),
            const _MetricTile(label: 'Transport', value: 'Authorization Bearer'),
            const SizedBox(height: 12),
            const _MetricTile(label: 'Session model', value: 'Shared opaque session'),
            const SizedBox(height: 24),
            FilledButton(
